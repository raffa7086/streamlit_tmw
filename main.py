...
def projecao_meta():
    ...
    return data_inicio_meta, valor_inicio, meta_estipulada, patrimonio_esperado
...
if file_upload is not None:
    ...
    with st.expander("Metas Financeiras"):
        ...
        tab_main, tab_data_meta, tab_grafico_meta = st.tabs(["Configuração", "Dados Projeção", "Gráfico Projeção"])

        with tab_main:
            data_inicio_meta, valor_inicio, meta_estipulada, patrimonio_esperado = projecao_meta()
        ...
        with tab_data_meta:
            ...
            meses["Atingimento Ano (%)"] = meses["Valor"] / patrimonio_esperado
            meses["Atingimento Esperado"] = meses["Meta Mensal"] / patrimonio_esperado
            meses = meses.set_index("Data Referência")

            columns_config_mensal = {
                "Meta Mensal": st.column_config.NumberColumn("Meta Mensal", format="R$ %f"),
            ...
            st.dataframe(meses, column_config=columns_config_mensal)

        with tab_grafico_meta:
